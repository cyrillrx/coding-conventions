...
- E2E: every critical journey has a Maestro flow in `.maestro/flows/`, one kebab-case file per journey — `launchApp: clearState: true`, commented steps, closing assertion. They complement, never replace, unit tests.
